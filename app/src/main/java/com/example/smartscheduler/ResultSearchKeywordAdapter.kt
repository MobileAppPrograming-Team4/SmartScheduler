...
class ResultSearchKeywordAdapter(val itemList : ArrayList<DestinationListLayout>) :
    RecyclerView.Adapter<ResultSearchKeywordAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultSearchKeywordAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.destination_list_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: ResultSearchKeywordAdapter.ViewHolder, position: Int) {
